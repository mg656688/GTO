...
for t in range(run_times):
    ...
    optimizer = GTO(fitness=benchmark.Sphere,
    ...
    optimizer = GTO(fitness=benchmark.Rastrigin,
    ...
    optimizer = GTO(fitness=benchmark.Ackley,
    ...
    optimizer = GTO(fitness=benchmark.Griewank,
    ...
    optimizer = GTO(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = GTO(fitness=benchmark.Rosenbrock,
    ...
    optimizer = GTO(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = GTO(fitness=benchmark.Quartic,
    ...
    optimizer = GTO(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = GTO(fitness=benchmark.Penalized1,
    ...
    optimizer = GTO(fitness=benchmark.Penalized2,
    ...
    optimizer = GTO(fitness=benchmark.Schwefel_226,
    ...
    optimizer = GTO(fitness=benchmark.Step,
    ...
    optimizer = GTO(fitness=benchmark.Kowalik,
    ...
    optimizer = GTO(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = GTO(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = GTO(fitness=benchmark.Branin,
    ...
    optimizer = GTO(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1] * np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0] * np.ones(dimension.Shekel())
    optimizer = GTO(fitness=benchmark.Shekel,
                    D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = GTO(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = GTO(fitness=benchmark.Hartmann6,
    ...
    optimizer = GTO(fitness=benchmark.Zakharov,
    ...
    optimizer = GTO(fitness=benchmark.SumSquares,
    ...
    optimizer = GTO(fitness=benchmark.Alpine,
    ...
    optimizer = GTO(fitness=benchmark.Michalewicz,
    ...
    optimizer = GTO(fitness=benchmark.Exponential,
    ...
    optimizer = GTO(fitness=benchmark.Schaffer,
    ...
    optimizer = GTO(fitness=benchmark.BentCigar,
    ...
    optimizer = GTO(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = GTO(fitness=benchmark.Elliptic,
    ...
    optimizer = GTO(fitness=benchmark.DropWave,
    ...
    optimizer = GTO(fitness=benchmark.CosineMixture,
    ...
    optimizer = GTO(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = GTO(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(GTO).csv')
